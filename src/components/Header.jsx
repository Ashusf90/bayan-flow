              ...
              repoData.stars >= 1000 && (
                <>
                  ...
                  <motion.button
                    ...
                    className="relative hidden md:flex overflow-hidden items-center gap-2 h-8 sm:h-9 px-3 sm:px-4 py-1.5 sm:py-2 bg-black text-white dark:bg-white dark:text-black rounded-md shadow-sm transition-all duration-300 ease-out group cursor-pointer"
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                  ...
                  >
                    ...
                    <div className="w-px h-4 sm:h-5 bg-white/20 dark:bg-black/20 relative z-10" />
                    <div className="flex items-center gap-1.5 relative z-10">
                      <Star
                        size={12}
                        className="sm:w-3.5 sm:h-3.5 transition-colors duration-300 group-hover:text-yellow-300"
                        fill="currentColor"
                        aria-hidden="true"
                      />
                  ...
                  <motion.button
                    onClick={handleGitHubClick}
                    className="flex md:hidden items-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-2 my-2 sm:my-0 bg-black text-white dark:bg-white dark:text-black rounded-md shadow-sm transition-all duration-200 cursor-pointer touch-manipulation"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    transition={{ type: 'spring', stiffness: 400, damping: 17 }}
                    aria-label={`${t('header.viewOnGithub')} (${repoData.stars} stars)`}
                  >
                    <Star
                      size={12}
                      className="sm:w-3.5 sm:h-3.5 transition-colors duration-300"
                      fill="currentColor"
                      aria-hidden="true"
                    />
